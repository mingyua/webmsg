...
class Wxpack {
    ...
    function __construct(){
        ...
        $this->apiclient_cert = getcwd() ."/extend/wxpay/cert/apiclient_cert.pem";
        $this->apiclient_key  = getcwd()."/extend/wxpay/cert/apiclient_key.pem";
        $this->apiclient_ca  = getcwd()."/extend/wxpay/cert/rootca.pem";
    }
    ...
    public function send(){
        ...
        if($data){
			...
			//var_dump($data);
				$back=['mch_billno'=>$rsxml->mch_billno,'re_openid'=>$rsxml->re_openid,'status'=>1];            	
                return $back;
            }else{
